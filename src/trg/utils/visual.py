...
from trg.grasp import Grasp
from trg.utils.transform import Transform, Rotation
from trg.utils.implicit import as_mesh

#########
# visualize affordance and grasp
#########
...
def plot_voxel_grid(voxel, size=5):
    cube = (voxel > 0)
...
def plot_tsdf_regulatory_factors(tsdf,
                          axis=None,
                          figsize=(5, 5),
                          marker='s',
                          s=8,
